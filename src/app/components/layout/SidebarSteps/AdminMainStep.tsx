  ...
  return (
    ...
    >
      <SideSection title="Gestión" icon="settings">
        ...
        <SideOption title="Gestionar Circuitos" href="/admin/routes" onClick={onClose} icon="route" iconColor="#0176DE"/>
      </SideSection>
      <SideSection title="Auditoría" icon="history">
        ...
        <SideOption title="Historial de Cambios de Circuitos" href="/admin/historico/routes" onClick={onClose} icon="timeline" iconColor="#0176DE"/>
      </SideSection>
    </ul>
  );
}
