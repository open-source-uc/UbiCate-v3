...
export async function GET() {
  try {
    const sqlPathRoutes = path.join(process.cwd(), "src", "sql", "getRoutesPending.sql");
    ...
    logger.info("Consulta de rutas pendientes completada:", normalized);
    ...
    logger.error("[DB] Error Rutas Pendientes:", err);
